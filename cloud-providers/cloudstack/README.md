...
CloudStack - Cloud Provider Registration
===========================
...
-   **API URL** - this the URL for accessing the CloudStack API
-   **API Key** - this is the key that can be generated from the CloudStack Console
-   **Secret Key** - this is the secret key that can be generated from the CloudStack Console
