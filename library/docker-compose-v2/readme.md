...
You can refer to the [Docker Compose v1](https://github.com/hypergrid-inc/documentation/edit/master/library/docker-compose-v2) documentation for examples on how to use plug-ins and data injection.
